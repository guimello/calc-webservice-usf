 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://service.web.motim.com.br/", wsdlLocation = "http://localhost:40384/CalculatorService/CalculatorService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://service.web.motim.com.br/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:40384/CalculatorService/CalculatorService?WSDL");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://service.web.motim.com.br/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.web.motim.com.br/", "CalculatorPort"), Calculator.class, features);
    }
